...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'A autenticação em dois fatores está ativa. Escaneie o QR code ou informe a chave no aplicativo autenticador.',
            buttonText: 'Fechar',
        };
    }
    ...
    return {
        ...
        description:
            'Para concluir, escaneie o QR code ou informe a chave manualmente no aplicativo autenticador',
        buttonText: 'Continuar',
    };
});
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            <span class="relative bg-card px-2 py-1"
                                >ou informe o código manualmente</span
                            >
                        </div>
